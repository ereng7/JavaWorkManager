package com.erengulbahar.javaworkmanager;
...
public class RefreshDatabase extends Worker
{
    ...
    {
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.erengulbahar.javaworkmanager",Context.MODE_PRIVATE);
